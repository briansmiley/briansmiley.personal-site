      ...
      <nav className="h-full">
        <ul className="font-semibold text-blue-200 underline flex justify-start h-full">
          ...
          <a href="https://github.com/briansmiley">
            <li className="flex items-center hover:bg-blue-500 w-fit h-full pr-2 pl-1">Github</li></a>
          <a href="https://www.linkedin.com/in/brian-smiley-1289a6121/">
            <li className="flex items-center hover:bg-blue-500 w-fit h-full pr-2 pl-1">LinkedIn</li></a>
        </ul>
      </nav>
    </header>)
    } 